...
<head>
    ...
    <style>
        ...
        h2 { font-size: 24px; margin-bottom: 8px; color: #ea4335; }
        ...
        .waiting-box { margin-top: 15px; font-size: 13px; color: #ea4335; display: flex; align-items: center; justify-content: center; gap: 8px; }
    </style>
</head>
<body>

<div class="payment-box">
    <h2>Nâng cấp AI Ultra Power</h2>
    ...
    <div class="info-row">
        <span>Số tiền:</span>
        <strong style="color: #ea4335;">349.000 đ</strong>
    </div>
    <div class="info-row">
        <span>Ngân hàng:</span>
    ...
    setInterval(function(){
        ...
        .then(data => {
            if(data.is_premium === 1 || data.is_premium === true) {
                alert('Thanh toán hoàn tất! Tài khoản của bạn đã được nâng cấp tự động lên bản ULTRA.');
